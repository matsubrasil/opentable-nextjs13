...
// const { PRICE, PrismaClient } = require('@prisma/client')
...
const main = async () => {
  try {
    ...
    console.log('Deleted records in Location table')

    // RESET
    // await prisma.$queryRaw`ALTER TABLE cuisine AUTO_INCREMENT = 1`
    // console.log('reset cuisine auto increment to 1')

    // await prisma.$queryRaw`ALTER TABLE item AUTO_INCREMENT = 1`
    // console.log('reset item auto increment to 1')

    // await prisma.$queryRaw`ALTER TABLE location AUTO_INCREMENT = 1`
    // console.log('reset location auto increment to 1')

    // await prisma.$queryRaw`ALTER TABLE restaurant AUTO_INCREMENT = 1`
    // console.log('reset restaurant auto increment to 1')
